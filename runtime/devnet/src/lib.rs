...
pub use parachain_common::{
	impls::{AssetsToBlockAuthor, DealWithFees},
	AccountId, AccountIndex, AssetId, AuraId, Balance, BlockNumber, Hash, Index, Signature,
...
pub use frame_support::{
	...
	traits::{
		...
		AsEnsureOriginWithArg, ConstU32, ConstU8, EitherOfDiverse, Everything, FindAuthor,
		InstanceFilter, KeyOwnerProofSystem, LockIdentifier, OnRuntimeUpgrade, PrivilegeCmp,
		Randomness,
	},
	weights::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("parachain-template-devnet"),
	impl_name: create_runtime_str!("parachain-template-devnet"),
	authoring_version: 1,
	spec_version: 1100,
	impl_version: 0,
...
pub const MICRO_UNITD: Balance = 1_000_000;
pub const MILLI_UNITD: Balance = 1_000 * MICRO_UNITD;
pub const CENTI_UNITD: Balance = 10 * MILLI_UNITD;
pub const UNITD: Balance = 100 * CENTI_UNITD;

pub const EXISTENTIAL_DEPOSIT: Balance = 50 * CENTI_UNITD;

const fn deposit(items: u32, bytes: u32) -> Balance {
	(items as Balance * MICRO_UNITD + (bytes as Balance) * (5 * MILLI_UNITD / 100)) / 10
}
...
parameter_types! {
	...
	pub const TransactionByteFee: Balance = 10 * MICRO_UNITD;
...
parameter_types! {
	pub const IndexDeposit: Balance = 10 * UNITD;
}
...
parameter_types! {
	pub const ConfigDepositBase: Balance = 500 * CENTI_UNITD;
	pub const FriendDepositFactor: Balance = 50 * CENTI_UNITD;
	pub const MaxFriends: u16 = 9;
	pub const RecoveryDeposit: Balance = 500 * CENTI_UNITD;
}
...
parameter_types! {
	pub const AssetDeposit: Balance = 10 * UNITD; // 10 UNITD deposit to create fungible asset class
...
parameter_types! {
	pub const CollectionDeposit: Balance = 10 * UNITD; // 10 UNIT deposit to create uniques class
	pub const ItemDeposit: Balance = UNITD / 100; // 1 / 100 UNIT deposit to create uniques instance
...
parameter_types! {
	...
	pub const MinimumDeposit: Balance = 100 * UNITD;
...
parameter_types! {
	pub const CandidacyBond: Balance = 100 * UNITD;
...
parameter_types! {
	...
	pub const ProposalBondMinimum: Balance = 100 * UNITD;
	pub const ProposalBondMaximum: Balance = 500 * UNITD;
	...
	pub const TipReportDepositBase: Balance = 1 * UNITD;
	pub const DataDepositPerByte: Balance = 1 * CENTI_UNITD;
...
parameter_types! {
	pub const BountyDepositBase: Balance = 1 * UNITD;
	pub const BountyDepositPayoutDelay: BlockNumber = 8 * DAYS;
	pub const BountyUpdatePeriod: BlockNumber = 90 * DAYS;
	pub const MaximumReasonLength: u32 = 16384;
	pub const CuratorDepositMultiplier: Permill = Permill::from_percent(50);
	pub const CuratorDepositMin: Balance = 10 * UNITD;
	pub const CuratorDepositMax: Balance = 200 * UNITD;
	pub const BountyValueMinimum: Balance = 10 * UNITD;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		//Governance
		Democracy: pallet_democracy::{Pallet, Call, Storage, Config<T>, Event<T>} = 43,
		Council: pallet_collective::<Instance1>::{Pallet, Call, Storage, Origin<T>, Event<T>, Config<T>} = 44,
		TechnicalCommittee: pallet_collective::<Instance2>::{Pallet, Call, Storage, Origin<T>, Event<T>, Config<T>} = 45,
		Treasury: pallet_treasury::{Pallet, Call, Storage, Config, Event<T>} = 46,
		PhragmenElection: pallet_elections_phragmen::{Pallet, Call, Storage, Event<T>, Config<T>} = 47,
		TechnicalMembership: pallet_membership::<Instance1>::{Pallet, Call, Storage, Event<T>, Config<T>} = 48,
		...
		EVM: pallet_evm = 51,
		BaseFee: pallet_base_fee = 52,

		// Bounties modules.
		Bounties: pallet_bounties::{Pallet, Call, Storage, Event<T>} = 60,
		ChildBounties: pallet_child_bounties = 61,

		// Tips module.
		Tips: pallet_tips::{Pallet, Call, Storage, Event<T>} = 62,
		...
		Indices: pallet_indices::{Pallet, Call, Storage, Config<T>, Event<T>} = 67,
	}
);
